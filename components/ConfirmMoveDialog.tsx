    ...
    <div className="fixed inset-0 z-50 flex flex-col justify-end bg-black/50" onClick={onCancel}>
      ...
      >
        <div className="flex items-center gap-2 text-harbor-orange">
          ...
          <h2 className="font-display text-base font-semibold text-ink">{t("move_collision_title")}</h2>
        </div>
        <p className="text-sm text-ink-dim">
          {t("move_collision_desc")} <span className="font-mono text-ink">{fileName}</span>
        </p>
